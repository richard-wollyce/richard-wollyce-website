...
Creator of Ulpia, an open-source local-first memory layer for AI agents written in Rust, with deterministic retrieval, a first-class abstention verdict, sub-millisecond warm queries, and an MCP server; published under Apache 2.0 with its benchmarks in the same repository.
Leads engineering at Casa Seth across infoproducts, Pix payments, attribution, server-side conversion tracking, financial reconciliation, and the BiblinhaPlay subscription platform.
...
**Web & Mobile:** React, TanStack Start/Router/Query, Next.js, Expo, React Native, Three.js, Vite, Tailwind CSS, responsive UI, PWA  
**Backend & Data:** Node.js, PostgreSQL, Supabase, Drizzle ORM, Better Auth, REST APIs, Edge Functions, Row-Level Security (RLS), Role-Based Access Control (RBAC)  
**Commerce & Analytics:** Pix, hosted checkout, idempotent webhooks, entitlements, revenue reconciliation, UTM attribution, server-side conversion tracking, PostHog, Mercado Pago, A/B testing  
**Platforms & Delivery:** Docker, Linux, Nginx, GitHub Actions, Vercel, EAS, CI/CD, Cargo, Tauri, BaseHub, self-managed VPS  
**Quality:** Vitest, Playwright, Maestro, TDD, automated linting, type checking, build gates, production monitoring, Biome, Lefthook  
**Security & Forensics:** Secure coding, secure data access, RBAC, RLS, network fundamentals, TCP/IP, incident response, digital evidence collection, chain of custody  
**Design & Modeling:** UML class, sequence, and component diagrams; architecture decision records  
**Methodologies:** Domain-driven design (DDD), specification-driven design (SDD), test-driven development (TDD), Agile
...
https://ulpia.io | https://github.com/richard-wollyce/ulpia
...
- Santander Bootcamp: Rust and AI-Integrated Application Development | Santander Bootcamp | Issued June 2026
- Computational Forensics and Digital Evidence Investigation | Universidade Cruzeiro do Sul | 40 hours | Issued June 2, 2026
- LEAD1x: Exercising Leadership: Foundational Principles | HarvardX / edX | Issued May 2026
- Networking Basics | Cisco Networking Academy | Issued July 2025
- Introduction to Cybersecurity | Cisco Networking Academy | Issued July 2023
