// The ambient field. Copied from ulpia.io's public/field.js on 4 September 2026,
// whole and unreinterpreted: the colours are read from CSS custom properties, so
// the only thing that changes between the two sites is the --shader-* tokens in
// globals.css. The comment below is the original's and still describes what runs.
//
// A full-viewport WebGL quad running classic Perlin
...
(function () {
  ...
  function readVars() {
    ...
    return {
      c1: hexToRgb(v("--shader-1", "#0f141a")),
      c2: hexToRgb(v("--shader-2", "#101a24")),
      c3: hexToRgb(v("--shader-3", "#1b2b3a")),
